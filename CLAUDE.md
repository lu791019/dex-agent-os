...
| 工作 | `meeting-notes --title "..." [--transcript FILE\|--notes\|--google-doc\|--fireflies]` | 多來源 → 會議筆記 |
| | `consultation-notes --title "..." --person "..." [同上]` | 多來源 → 諮詢紀錄 |
| | `project-status [專案名]` | 讀 STATUS.md + git log → LLM 更新 |
| | `classroom-sync [--courses\|--announcements\|--coursework]` | Google Classroom 同步（老師角色） |
