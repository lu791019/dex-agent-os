...
- [ ] A4. GCP 啟用 Sheets API + 刪 token 重新授權 ← **需手動跑授權**
...
- [ ] B7. 真實寫入測試（需先完成 A4 授權）

## Section B+：reader_to_sheets 增強
- [ ] B+1. LLM 中文摘要（取代 Reader 的英文 summary）
- [ ] B+2. LLM 主題分類（技術/生產力/職涯/創作/投資/...）
- [ ] B+3. email 的 source_url 為空（已處理 mailto: 清除）
- [ ] B+4. Sheet 欄位更新：加「主題」欄
